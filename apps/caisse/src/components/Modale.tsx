...
export function Modale({ titre, enfants, onFermer, large }: Props) {
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/70 p-4" onClick={onFermer}>
      <div
      ...
      >
        <div className="mb-4 flex items-center justify-between">
          ...
          <button type="button" className="btn-sombre px-3" onClick={onFermer}>
            ✕
          </button>
        </div>
        {enfants}
